./pycbc_make_multiband_nomargin_inference \
...
--lisa-obs-duration 1 \
--inference-config prior_multiband_nomargin.ini \
--config-files workflow_multiband_nomargin.ini \
--workflow-name multiband_nomargin_workflow_seed_1_obs_1yr_wait_5yrs_nessai \
--output-dir ./output_multiband_nomargin_seed_1_obs_1yr_wait_5yrs_nessai --submit-now
