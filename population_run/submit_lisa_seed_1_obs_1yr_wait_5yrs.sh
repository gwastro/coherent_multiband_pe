...
--lisa-obs-duration 1 \
--inference-config prior_lisa.ini \
--config-files workflow_lisa.ini \
--workflow-name lisa_workflow_seed_1_obs_1yr_wait_5yrs_nessai \
--output-dir ./output_lisa_seed_1_obs_1yr_wait_5yrs_nessai --submit-now
